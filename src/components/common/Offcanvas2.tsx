...
import offcanvas_1 from "@/assets/img/offcanvas/developer.png";
        ...
        <div className="tp-offcanvas-wrapper">
          <div className="tp-offcanvas-top-2 d-flex align-items-center justify-content-between">
            <div className="tp-offcanvas-logo-2">
              <a href="#">
                ...
                <h3 className='text-white'>Anuj Kaushik</h3>
              </a>
            </div>
          ...
          <div className="tp-offcanvas-main-2">
              ...
              <div className="row gx-2">
                <div className="col-md-3 col-3">
                  <div className="tp-offcanvas-gallery-img fix">
                    <a href="#"><Image src={offcanvas_1} alt="image" height='80'/></a>
                  </div>
                </div>
                <div className="col-md-3 col-3">
                  <div className="tp-offcanvas-gallery-img fix">
            ...
            <div className="tp-offcanvas-contact-2">
              ...
              <ul>
                <li><a href="tel:7253874540">91+ 7253874540</a></li>
                <li><a href="mailto:anujkaushik380@gmail.com">anujkaushik380@gmail.com</a></li>
                <li><a href="#">One Internation Centre, Mumbai</a></li>
              </ul>
            </div>
            <div className="tp-offcanvas-social-2">
              ...
              <ul>
                <li>
                  <a href="https://www.instagram.com/anujkaushik83/" target='_blank'>
                ...
                <li>
                  <a href="https://www.facebook.com/anuj.kaushik.353" target='_blank'>
                ...
                <li>
                  <a href="mailto:anujkaushik380@gmail.com" target='_blank'>
                ...
                <li>
                  <a href="https://twitter.com/AnujKau34882119" target='_blank'>
