...
const portfolio_content = {
    ...
    portfolio_data: [
        ...
        },
        {
            ...
            title: "World Trading Leagues",
            link: 'https://worldtradingleagues.com/'
        }
    ]
}
    ...
    return (
        <>
            <section className="tp-portfolio-area tp-btn-trigger-2 p-relative z-index-1 pt-280 pb-40 fix">
                <div
                    className="tp-portfolio-top-text tp-portfolio-bg-text d-flex align-items-center tp-portfolio-bg-text-animation">
                    <p>{title}</p>
                    <p>{title}</p>
                </div>
                        ...
                        <div className="col-xl-6 col-lg-6">
                            <div className="tp-portfolio-wrapper pr-30 pt-55">
                                ...
                                <div className="tp-portfolio-item-wrapper">
                                    <Link href="https://marraforni.com/" target='_blank'>
                                        <div className="tp-portfolio-item mb-70">
                                            ...
                                            <div className="tp-portfolio-thumb img-1 w-img fix ">
                                                ...
                                                <div className="tp-portfolio-thumb-img ">
                                                    <Image data-speed="0.85"
                                                           style={{objectFit: 'cover', height: "auto"}}
                                                           src={portfolio_img_1} alt="image-here"/>
                                                </div>
                                            </div>
                                            <div className="tp-portfolio-content">
                                                <h3 className="tp-portfolio-title">Marraforni </h3>
                                                <div className="tp-portfolio-meta d-flex align-items-center">
                                                    <span className="tp-portfolio-meta-count">1</span>
                            ...
                            <RitghtArrowIconPortfolio/>
                                ...
                                <div
                                    className="tp-portfolio-more tp-hover-btn-wrapper tp-btn-bounce-2 d-none d-lg-block">
                                    <Link href="/"
                                        ...
                                        <Link href={item.link} target="_blank">
                                            <div key={i} className="tp-portfolio-item mb-70">
                                                ...
                                                <div className="tp-portfolio-thumb img-2 w-img fix">
                                                    ...
                                                    <div className="tp-portfolio-thumb-img">
                                                        <Image data-speed="0.85" style={{height: "auto",}} src={item.img}
                                                               alt="image-here"/>
                                                    </div>
                                                </div>
                                                <div className="tp-portfolio-content">
                                                    ...
                                                    <div className="tp-portfolio-meta d-flex align-items-center">
                                                        <span className="tp-portfolio-meta-count">{item.id}</span>
                                                        <span className="tp-portfolio-meta-arrow">
                            <RitghtArrowIconPortfolio/>
                          </span>
                                                        <div className="tp-portfolio-meta-hover">
