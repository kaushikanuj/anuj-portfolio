...
import blog_img_3 from "@/assets/img/blog/coding.jpg";
import blog_img_4 from "@/assets/img/blog/coding2.jpg";
import blog_img_5 from "@/assets/img/blog/coding3.jpg";
      ...
      tab_items: [
        {
          ...
          title: "How to get the query params from a URL in Next.js (2021)",
          category: "https://anujkaushik380.medium.com/how-to-get-the-query-params-from-a-url-in-next-js-21cdd69b551d",
        },
        {
          img: blog_img_4,
          date: "June 12, 2023",
          title: "What is Virtual Dom (2021)",
          category: "https://anujkaushik380.medium.com/what-is-virtual-dom-2021-202daebb4e2f",
        },
        {
          img: blog_img_5,
          date: "May 21, 2023",
                              ...
                              <div className="tp-course-item">
                                <div className="tp-course-thumb-wrap p-relative">
                                  <div className="tp-course-thumb fix">
                                    <Link href={`${inner_item.category}`}>
                                      <Image width='500' src={inner_item.img} alt="image-here" />
                                    </Link>
                                  </div>
                                ...
                                <div className="tp-course-content">
                                  ...
                                  <h3 className="tp-course-title">
                                    <Link href={`${inner_item.category}`}>{inner_item.title}</Link>
                                  </h3>
                                  <div className="tp-course-price-btn-box d-flex align-items-center">
                                    <Link href={`${inner_item.category}`} className="tp-course-price-btn">
                                      <span className="new-price">Read More</span>
