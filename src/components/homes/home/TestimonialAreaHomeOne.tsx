...
const testimonial_content: DataType = {
  ...
  info: "Rated 4.3 out of 5 based on 22 reviews",
  testimonial_slider_data: [
    {
      id: 1,
      rating_text: "5.0 Rating",
      description: `This was my first experience working with Anuj's team and honestly right from the beginning till end, they have a through professional attitude and dedication to the project. Code provided was flawless, works like a charm. Testing and communication back and forth handled very well. Highly recommended"`,
    },
    {
      id: 2,
      rating_text: "5.0 Rating",
      description: `Anuj is a great developer. I have worked with him multiple times and every time he delivers high-quality work on time. He is open to communication and is very accommodating.`,
    },
    {
      id: 3,
      rating_text: "5.0 Rating",
      description: `Anuj was a Good to work with. He communicates well and met every deadline. I would definitely work with him again!`,
    },
    // {
    //   id: 4,
    //   rating_text: "5.0 Rating",
                      ...
                      <div key={index} className="swiper-slide">
                        <div
                          ...
                          <div className="tp-testimonial-user-content">
                            ...
                            <span className="tp-testimonial-user-designation" style={{fontSize:'13px'}}>{item.designation}
