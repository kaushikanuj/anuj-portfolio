...
const service_content = {
  ...
  sm_des: <>The combination of my passion for design, code & <br /> interaction web development world.</>,
  accordion_data: [
    {
      id: 1,
      tab_id: "One",
      question: "UI/UX Design",
      answer: "I value simple content structure, clean design patterns, and thoughtful interactions.",
      some_features: [
        "Interface design",
    ...
    },
    {
      ...
      answer: "I like to code things from scratch, and enjoy bringing ideas to life in the browser.",
      some_features: [
        "Bitbucket",
        "Bootstrap",
        "Javascript",
    ...
    },
    {
      ...
      answer: "Digital marketing: amplifying brand visibility and engagement through strategic online channels.",
      some_features: [
        "On Page SEO",
        "Off Page SEO",
      ]
    },
    {
      ...
      tab_id: "Three",
      question: "Mentor",
      answer: "I genuinely care about people, and enjoy helping them work on their craft.",
      some_features: [
        "4+ years experience",
      ]
    },
