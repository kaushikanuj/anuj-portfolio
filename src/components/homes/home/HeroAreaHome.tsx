...
const hero_content: DataType = {
  ...
  words: ["Web", "App", "UI"],
  title_2: "developer",
  sm_info: <>I like to craft solid and scalable frontend products with great user experiences.</>,
            ...
            <div className="col-xl-7 col-lg-7 col-md-12">
              <div className="tp-hero-left-wrapper">
                <div className="tp-hero-content tp_text_anim p-relative z-index-1">
                  <span className="singleLine">{sub_title} <Image src={HeroHand} alt="anuj-image" /></span>
            ...
            <div className="col-xl-5 col-lg-5 col-md-12">
              <div className="tp-hero-thumb-wrapper text-center text-lg-end p-relative z-index-1">
                <div className="tp-hero-thumb-shape">
                  ...
                  <Image className="tp-hero-thumb-shape-2 d-none d-xl-block" data-speed="1.2" src={HeroShape2} alt="anuj-image" />
                  <span className="tp-hero-thumb-shape-3"></span>
                </div>
                <div className="tp-hero-thumb">
                  <Image src={HeroImage} style={{ height: 'auto' }} alt="anuj-image" />
                </div>
              </div>
            </div>
          </div>
